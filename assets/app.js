...
/* v4.3.1: fix lobby→bet click via event delegation; remove stray code; add guards */
const I18N = {
...
function renderBetsDrawer(){
  ...
  STATE.betsHistory.forEach(batch=>{
    const li=document.createElement("li"); const total=batch.items.reduce((s,it)=>s+(it.stake||0),0);
